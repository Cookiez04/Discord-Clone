...
import { Hash, Bell, Pin, Users, Search, PlusCircle, Gift, Sticker, Smile, HelpCircle, Inbox, MessageSquare, Trash2, Edit2, Reply, X, Command, AtSign } from 'lucide-react';
    ...
    return (
        <div className="h-6 flex items-center px-4 shrink-0 animate-in fade-in duration-300">
            <div className="flex space-x-1 mr-2">
                <div className="w-1.5 h-1.5 bg-discord-text-normal rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                <div className="w-1.5 h-1.5 bg-discord-text-normal rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                <div className="w-1.5 h-1.5 bg-discord-text-normal rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
            </div>
    ...
    <div className="flex-1 flex flex-col min-w-0 bg-discord-dark relative">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar flex flex-col pb-4" ref={scrollRef}>
        ...
        <div className="flex flex-col justify-end">
            ...
            if (prevMsg && prevMsg.userId === msg.userId && !msg.replyToId && !prevMsg.replyToId) {
